...
// CHECK: CFL_2D — двумерное условие CFL
...
// CHECK: RECONSTRUCTION — MUSCL/minmod реконструкция на гранях
...
// CHECK: HLLC_SOLVER — HLLC солвер Римана
...
// CHECK: STATE_VECTOR_2D — U=(rho, rho*u, rho*v, E)^T и физические потоки F/G
